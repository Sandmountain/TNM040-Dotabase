var demo = angular.module('demo', [
    ...
    function AppController($filter, $log, $scope,  dotaService, abilitiesService, itemsService) {
        ...
        vm.slides = [
            ...
            {'src': 'images/heroes/doom_vert.jpg', caption: 'Doom'},
            ...
            {'src': 'images/heroes/earthshaker_vert.jpg', caption: 'Earthshaker'},
            ...
            {'src': 'images/heroes/Faceless_void_vert.jpg', caption: 'Faceless Void'},
            ...
            {'src': 'images/heroes/Natures_Prophet_vert.jpg', caption: "Nature's Prophet"},
            ...
            {'src': 'images/heroes/phantom_lancer_vert.jpg', caption: 'Phantom Lancer'},
            {'src': 'images/heroes/phoenix_vert.jpg', caption: 'Phoenix'},
            {'src': 'images/heroes/puck_vert.jpg', caption: 'Puck'},
            {'src': 'images/heroes/pudge_vert.jpg', caption: 'Pudge'},
            ...
            {'src': 'images/heroes/skywrath_mage_vert.jpg', caption: 'Skywrath Mage'},
            ...
            {'src': 'images/heroes/tusk_vert.jpg', caption: 'Tusk'},
